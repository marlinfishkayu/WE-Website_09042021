var arrLang = {
    'EN': {
      ...
      //
      'Lottery':'LOTTERY',
      'gameDetail_p1': 'Lotto-5 is a popular lottery across China. It is an interesting game and includes a variety of betting choices with attractive odds. Players need to bet on the combination of numbers so could become the winners.',
    ...
    'TC': {
      ...
      //
      'Lottery':'彩票',
      'gameDetail_p1': '時時彩是紅透全國彩票遊戲。遊戲不僅富有趣味性，投注方式也是五花八門，同時極為吸引高賠率獎金。玩家只需要押中開獎彩球號碼排列組合，豐厚獎金隨即奉上。',
      'feature_1.1': '投注選項',
      'feature_1.2': '豐富多變',
      'feature_1_p': '「時時彩」備有多種投注組合可供選擇，且每款組合派彩回報也各有不同，賠率千變萬化，玩家隨時搏取更豐厚獎金。',
      'feature_2.1': '自定籌碼金額',
      'feature_2.2': '',
    ...
    'SC': {
      ...
      //
      'Lottery':'彩票',
      'gameDetail_p1': '时时彩是红透全国彩票游戏。游戏不仅富有趣味性，投注方式也是五花八门，同时极为吸引高赔率奖金。玩家只需要押中开奖彩球号码排列组合，丰厚奖金随即奉上。',
      'feature_1.1': '投注选项',
      'feature_1.2': '丰富多变',
      'feature_1_p': '「时时彩」备有多种投注组合可供选择，且每款组合派彩回报也各有不同，赔率千变万化，玩家随时搏取更丰厚奖金。',
      'feature_2.1': '自定筹码金额',
      'feature_2.2': '',
