var arrLang = {
    'EN': {
      ...
      //
      'Lottery':'LOTTERY',
      'gameDetail_p1': 'Lotto-5 is a popular lottery across China. It is an interesting game and includes a variety of betting choices with attractive odds. Players need to bet on the combination of numbers in order to win the game.',
      'feature_1.1': 'Massive betting',
      'feature_1.2': 'options',
      'feature_1_p': 'Lotto-5 offers a wide range of betting choices with different odds for selection. Players can take the chances of winning bigger and enchanting awards.',
      'feature_2.1': 'Customize chip',
      'feature_2.2': 'amount',
      'feature_2_p': 'WE offer the standardized chips, but players are also able to set the chip amounts in “Entertainment” mode to win more generous bonuses.',
      'feature_3.1': 'Grasp the game',
      'feature_3.2': 'tendency',
      'feature_3_p': 'WE provide a series of statistics which include comprehensive scoreboards and results. It saves the players’ preparation time before betting through displaying the trend of the game in the chart clearly.',
    },
    ...
    'TC': {
      ...
      //
      'Lottery':'彩票',
      'gameDetail_p1': '時時彩是紅遍全中國的彩票遊戲。遊戲不僅富有趣味性，投注方式也是五花八門，同時具有吸引力的高賠率獎金。玩家只需要押中開獎彩球號碼的排列組合，豐厚獎金隨即奉上。',
      'feature_1.1': '投注選項',
      'feature_1.2': '豐富多變',
      'feature_1_p': '「時時彩」備有多種投注組合可供玩家選擇，且每款組合的派彩回報也各有不同，賠率千變萬化，玩家隨時搏取更誘人的獎金。',
      'feature_2.1': '自定籌碼金額',
      'feature_2.2': '',
      'feature_2_p': '除了系統預設的籌碼外，玩家可跳轉至「娛樂」模式，設定不一樣的籌碼金額，贏取更豐盛的獎金。',
      'feature_3.1': '數據 掌握',
      'feature_3.2': '遊戲走勢',
      'feature_3_p': '我們提供一系列的數據提示，包括全方位路紙和開獎結果；透過數據走勢分析開獎結果，以圖表方式顯示，一目了然，為玩家節省下注前的準備時間。',
    },
    ...
    'SC': {
      ...
      //
      'Lottery':'彩票',
      'gameDetail_p1': '时时彩是红遍全中国的彩票游戏。游戏不仅富有趣味性，投注方式也是五花八门，同时具有吸引力的高赔率奖金。玩家只需要押中开奖彩球号码的排列组合，丰厚奖金随即奉上。',
      'feature_1.1': '投注选项',
      'feature_1.2': '丰富多变',
      'feature_1_p': '「时时彩」备有多种投注组合可供玩家选择，且每款组合的派彩回报也各有不同，赔率千变万化，玩家随时搏取更诱人的奖金。',
      'feature_2.1': '自定筹码金额',
      'feature_2.2': '',
      'feature_2_p': '除了系统预设的筹码外，玩家可跳转至「娱乐」模式，设定不一样的筹码金额，赢取更丰盛的奖金。',
      'feature_3.1': '数据 掌握',
      'feature_3.2': '遊戲走勢',
      'feature_3_p': '我们提供一系列的数据提示，包括全方位路单和开奖结果；透过数据走向分析开奖结果，以图表方式显示，一目了然，为玩家节省下注前的准备时间。',
    }
  };
