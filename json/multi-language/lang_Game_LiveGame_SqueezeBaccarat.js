var arrLang = {
    'EN': {
      ...
      'feature_1_p': 'WE have incorporated a 3D interactive design in Squeeze Baccarat. Players can simply tap or click on the corner of each card to expose the card value or just hit the “Open” button without squeezing as long as place bets on “Banker” or “Player”.',
      ...
      'feature_3_p': '“Squeeze Tutorial” will automatically pop up to players who participated in Squeeze Baccarat for the first time. Our 3D demonstration will clearly introduce the squeezing methods which help the players truly enjoy the game.',
    },
    ...
    'TC': {
      ...
      'feature_1.1': '3D 揭牌展示',
      'feature_1.2': '仿如置身現場',
      'feature_1_p': '我們在共咪百家樂中加入3D互動設計，玩家只要下注「庄」、「閒」，即可參與咪牌，有如置身現場，感受開牌的緊張刺激。',
      'feature_2': '詳盡統計數據',
      'feature_2_p': '遊戲大堂清晰展示百家樂本靴及過往100局各投注區的勝出比例，各枱趨勢一目了然。玩家如果遇上心水局數，更可用「快速投注」功能在大堂直接下注。',
      'feature_3': '咪牌教學',
      'feature_3_p': '首次參與共咪百家樂的玩家，系統會自動展示「咪牌教學」，以3D模式簡單清晰地介紹互動咪牌方法，讓玩家掌握咪牌的竅門。',
    },
    ...
    'SC': {
      ...
      'feature_1.1': '3D 揭牌展示',
      'feature_1.2': '仿如置身现场',
      'feature_1_p': '我们在共咪百家乐中加入3D互动设计，玩家只要下注「庄」、「闲」，即可参与咪牌，有如置身现场，感受开牌的紧张刺激。',
      'feature_2': '详细数据统计',
      'feature_2_p': '游戏大堂清晰地展示百家乐本靴及过往100局各投注区的胜出比例，各游戏桌趋势一目了然。玩家如果遇上合意的局数，更可用「快速投注」功能在大堂直接下注。',
      'feature_3': '咪牌教学',
      'feature_3_p': '首次参与共咪百家乐的玩家，系统会自动展示「咪牌教学」，以3D模式简单清晰地介绍咪牌方法，让玩家掌握咪牌的诀窍。',
    }
  };
