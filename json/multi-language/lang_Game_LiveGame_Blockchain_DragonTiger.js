var arrLang = {
    'EN': {
      ...
      'feature_3_p': 'WE understand that many Dragon Tiger lovers like to track the past scores and results to predict the next outcome, so our "Next Banker" and “Next Player” function allows players to make predictions and place bets easily.',  
    },
    ...
    'TC': {
      ...
      'feature_1.1': '極速遊戲',
      'feature_1.2': '簡單易玩',
      'feature_1_p': '龍虎玩法非常簡單，當中只有「龍」、「虎」、「和」三個投注區，以牌面的大小來決定勝負，節奏明快，簡單易玩。',
      'feature_2.1': '多項清晰的',
      'feature_2.2': '遊戲記錄',
      'feature_2_p': '在娛樂大廳，玩家只要挑選專業版路紙，便可見龍虎過往100局的結果統計數據；進入現場遊戲版面，更可見各種路紙，包括珠盤、大路、大眼仔、小路及曱甴路，遊戲趨勢盡在掌握。',
      'feature_3.1': '隨時「問路」',
      'feature_3.2': '預測結果 ',
      'feature_3_p': '我們明白不少龍虎愛好者均喜歡問路來預測遊戲結果，因此特設「問路」功能，讓玩家做好預測，輕鬆下注。',
    },
    ...
    'SC': {
      ...
      'feature_1.1': '极速游戏',
      'feature_1.2': '简单易玩',
      'feature_1_p': '龙虎玩法非常简单，当中只有「龙」 、「虎」 、「和」三个投注区，以牌面的大小来决定胜负，节奏明快，简单易玩。',
      'feature_2.1': '多项清晰的',
      'feature_2.2': '游戏记录',
      'feature_2_p': '在游戏大堂，玩家只要挑选专业版路單，便可见龙虎过往100局的结果统计数据；进入现场游戏版面，更可见各种路單，包括「珠盘路」、「大路」、「大眼路」、「小路」及「小強路」，游戏趋势尽在掌握。',
      'feature_3.1': '随时「问路」',
      'feature_3.2': '预测结果 ',
      'feature_3_p': '我们明白不少龙虎爱好者均喜欢问路来预测游戏结果，因此特设「问路」功能，让玩家做好预测，轻松下注。',
    }
  };
