var arrLang = {
  ...
  'TC': {
    ...
    'ContactUs_p2' : '填寫此表即表示你同意並願意讓我們收集閣下聯繫方式和其他信息，以使我們能夠有效地答覆你所有詢問。有關更多詳細信息，請查看我們隱私政策。',
  ...
  'SC': {
    ...
    'ContactUs_p2' : '填写此表即表示你同意并愿意让我们收集阁下联系方式和其他信息，以使我们能够有效地答覆你所有询问。有关更多详细信息，请查看我们隐私政策。',
