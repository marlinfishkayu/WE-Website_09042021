var arrLang = {
  'EN': {
    ...
    'ContactUs_p1' : 'Leave us your message by filling the contact form below and WE’ll be in touch with you soon.',
  ...
  'TC': {
    ...
    'Other' : '其他',
    //textarea
    'message' : '請在此處輸入你的查詢的內容。',
    //check form
    'statement_agree' : '是，我同意隱私政策*。',
    'statement_promotional' : '我同意通過電子郵件收到你的營銷促銷材料和最新消息。',
    //submit
    'submit' : '提交查詢',
    'Whats_more' : "更多",
    'work_with_us' : '跟我們工作',
  ...
  'SC': {
    ...
    'Other' : '其他',
    //textarea
    'message' : '请在此处输入你的查询的内容。',
    //check form
    'statement_agree' : '是，我同意隐私政策*。',
    'statement_promotional' : '我同意通过电子邮件收到你的营销促销材料和最新消息。',
    //submit
    'submit' : '提交查询',
    'Whats_more' : "更多",
    'work_with_us' : '跟我们工作',
