var arrLang = {
    'EN': {
      ...
      'feature_1.2': 'of odds',
      'feature_1_p': 'Sic Bo is very popular amongst players. The wide variety of odds and combinations are the features that attracted the players. Thus, they can increase their chances of getting a huge profit in this game. ',
      'feature_2.1': 'Comprehensive',
      'feature_2.2': 'game statistics',
      'feature_2_p': 'To allow players to better grasp the game tendency, Sic Bo specially displays the records of "Even/Odd", "Big/Small" and the "Sum" in the past multiple rounds, and sets "Big/Small/Alls" and "Even/Odd/Alls". It makes the game more predictable.',
    ...
    'TC': {
      ...
      'feature_1.1': '多元化投注區',
      'feature_1.2': '贏取更高獎賞',
      'feature_1_p': '一直以來，骰寶深受玩家歡迎，多元化的投注區及極高的賠率，令玩家隨時可贏得意想不到的豐厚獎賞。',
      'feature_2.1': '展示實時數據',
      'feature_2.2': '勝券在握',
    ...
    'SC': {
      ...
      'feature_1.1': '多元化投注区',
      'feature_1.2': '赢取更高奖赏',
      'feature_1_p': '一直以来，骰宝深受玩家欢迎，多元化的投注区及极高的赔率，令玩家随时可赢得意想不到的丰厚奖赏。',
      'feature_2.1': '展示实时数据',
      'feature_2.2': '胜券在握',
      'feature_2_p': '为了让玩家更能掌握游戏走势，骰宝提供过往多局的「单／双」、「大／小」及「和值」记录，并设「大／小／围」及「单／双／围」的结果统计数据，万事俱备，自然胜券在握！',
      'feature_3': '多款清晰路单',
      'feature_3_p': '下注前，不少玩家会经常翻查路单纪录，因此我们特设「专业版」、「普通版」、「简易版」路单，按照玩家的实际需要，选择最适合自己的版本，快速地进行投注。',
    }
  };
...
var arrImg = {
  'EN': [{
      ...
      //'UI': 'images/game/game_sicbo/en/game_UI_SicBo_x1.png 500w,images/game/game_sicbo/en/game_UI_SicBo_x2.png 1000w',
      //Feature
