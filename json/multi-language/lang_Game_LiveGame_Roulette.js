var arrLang = {
    'EN': {
      ...
      'feature_2.2': 'areas',
      'feature_2_p': 'Players can enjoy flexible betting options for Roulette. They can bet on the “Central Roulette Platform” or exploit the “Roulette Racetrack”. Players are able to bet on any  no. and place multiple bets in a short time.',
      'feature_3.1': 'Hot and ',
      'feature_3.2': 'Cold no.',
      'feature_3_p': 'WE specially displayed 5 "Hot/Cold" no. that appear the most frequently and the least frequently no. in the last 100 rounds, that allows players to make predictions and place bets easily.',
    },
    ...
    'TC': {
      ...
      'feature_1.1': '多元投注選項',
      'feature_1.2': '重現歐洲經典',
      'feature_1_p': '多年來，輪盤乃是歐洲最經典的遊戲之一，玩家可選擇「直接注」、「分注」、「街注」、「角注」等選項，玩法精彩多變！',
      'feature_2.1': '雙重投注區',
      'feature_2.2': '迎合玩家需求',
      'feature_2_p': '玩家可以根據自己的喜好，選擇「中間下注區」或「馬場下注區」版面，挑選自己的心水號碼，並在短時間內進行多重投注。 ',
      'feature_3.1': '「冷/熱」號碼',
      'feature_3.2': '清晰易明',
    ...
    'SC': {
      ...
      'feature_1.1': '多元投注选项',
      'feature_1.2': '重现欧洲经典',
      'feature_1_p': '多年来，轮盘乃是欧洲最经典的游戏之一，玩家可选择「直接注」、「分注」、「街注」、「角注」等选项，玩法精彩多变！',
      'feature_2.1': '双重投注区',
      'feature_2.2': '迎合玩家需求',
      'feature_2_p': '玩家可以按自己的喜好，选择「中间投注区」或「马场投注区」版面，挑选自己的心儀号码，并在短时间内进行多重投注。',
      'feature_3.1': '「冷/热」号码',
      'feature_3.2': '清晰易明',
